...
public class RefreshActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void getLoc() {
        ...
        if (ActivityCompat.checkSelfPermission(RefreshActivity.this, ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            return;
        }

        client.getLastLocation().addOnSuccessListener(RefreshActivity.this, new OnSuccessListener<Location>() {
            @Override
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    Intent i = new Intent(RefreshActivity.this, MainActivity.class);
